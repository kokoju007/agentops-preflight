/**
 * E2E Test: POST /tx/preflight (0.10 USDC) — single payment only
 */
...
async function main() {
  console.log('=== E2E: POST /tx/preflight (0.10 USDC) ===\n');
  ...
  // Build sample mainnet transaction (self-transfer 0.001 SOL)
